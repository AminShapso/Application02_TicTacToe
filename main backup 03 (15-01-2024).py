...
symbols_in_series_for_a_win = (3, 3, 3)
# symbols_in_series_for_a_win = (3, 3, 4)
...
class TicTacToe:
    ...
    def draw_player(self, player_number, logical_position):
        grid_position = self.convert_logical_to_grid_position(logical_position) + self.convert_logical_to_grid_position(logical_position)
    ...
    def is_winner(self, player):
        ...
        for x in range(board_matrix[1]):
            for z in range(board_matrix[0] - symbols_in_series_for_a_win[0] + 1):
                # print(f'row = {[(n + z, x) for n in range(symbols_in_series_for_a_win[0])]}')
        ...
        for y in range(board_matrix[0]):
            for z in range(board_matrix[1] - symbols_in_series_for_a_win[1] + 1):
                # print(f'column = {[(y, n + z) for n in range(symbols_in_series_for_a_win[1])]}')
        ...
        for x in range(board_matrix[0] - symbols_in_series_for_a_win[2] + 1):
            for y in range(board_matrix[1] - symbols_in_series_for_a_win[2] + 1):
                # print(f'diagonal 1 = {[(n + x, n + y) for n in range(symbols_in_series_for_a_win[2])]}')
                ...
                # print(f'diagonal 2 = {[(n + x, symbols_in_series_for_a_win[2] - 1 - n + y) for n in range(symbols_in_series_for_a_win[2])]}')
